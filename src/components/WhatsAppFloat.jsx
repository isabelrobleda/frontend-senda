...
function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      aria-label="Agenda tu visita por WhatsApp"
      className="fixed bottom-5 right-5 z-50 w-14 h-14 rounded-full bg-[#25d366] shadow-lg flex justify-center items-center hover:scale-105 transition-transform"
    >
      <svg
        className="w-8 h-8"
        viewBox="0 0 24 24"
