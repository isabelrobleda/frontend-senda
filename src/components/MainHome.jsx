        ...
        <div className="grow shrink basis-0 flex-col justify-start items-center gap-8 inline-flex">
          <div className="self-stretch flex-col justify-start items-start gap-6 flex">
            ...
            <h3 className="self-stretch text-[#757575] text-md md:text-lg font-semibold font-['Inter'] leading-snug md:leading-[24.80px]">
              ...
              de cada alumno. Formamos personas críticas, responsables, competentes, y resilientes, para que <br className="hidden md:block"/> sean agentes de cambio en su entorno.
            </h3>
          </div>
