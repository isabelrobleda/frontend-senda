  ...
  return (
    <div className="relative w-full md:h-screen px-4 md:px-16 py-20 md:py-40 flex-col justify-center items-center gap-8 inline-flex">
      <div className="absolute inset-0 z-0">
        <img
          className="w-screen object-cover opacity-10 z-0 md:h-screen"
      ...
      <div className="md:mx-0 w-full max-w-[1440px] mx-6 relative self-center z-10 justify-between items-center flex flex-col-reverse md:flex-row">
        <div className="grow shrink basis-0 flex-col justify-start items-center gap-8 inline-flex">
          <div className="self-stretch flex-col justify-start items-start gap-6 flex">
            ...
            <h3 className="self-stretch text-[#757575] text-md md:text-lg font-semibold font-['Inter'] leading-snug md:leading-[24.80px] md:w-[600px]">
              Somos una comunidad educativa inmersa en la cultura de
              pensamiento, comprometida con el bienestar emocional
              de cada alumno. Formamos personas críticas, responsables, competentes, y resilientes, para que
