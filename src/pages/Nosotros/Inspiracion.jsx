...
function Inspiracion() {
  return (
    <div className="w-full flex flex-col items-center">
      <div className="w-full max-w-[1440px] bg-white flex flex-col md:flex-row justify-center items-start gap-12 p-8 md:p-16">
        <div className="w-full md:w-1/2 flex justify-center md:justify-end">
          <img src="src/assets/inspiracion01.png" alt="" className="h-96 w-auto" />
        </div>
      ...
      <div className="w-full max-w-[1440px] bg-white flex flex-col md:flex-row justify-center items-start gap-12 p-8 md:p-16 mt-16 mb-40">
        <div className="w-full md:w-1/2 flex flex-col justify-center items-start gap-4 p-4 ">
          <div className="text-[#1e1e1e] text-5xl font-bold font-['Inter'] leading-tight">
            Convicción
          </div>
        ...
        <div className="w-full md:w-1/2 flex justify-center md:justify-start">
          <img src="src/assets/conviccion.png" alt="" className="h-96 w-auto" />
        </div>
      </div>
    </div>
  );
