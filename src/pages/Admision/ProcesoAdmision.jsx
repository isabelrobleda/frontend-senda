  ...
  return (
    <div>
      <div className="relative">
        {/* Carousel Section */}
        <div className="h-auto w-full px-4 md:px-16 py-20 bg-[#f9f9fe] flex-col justify-center items-center gap-20 flex ">
          <div className="flex justify-center items-center">
            {/* Image Section */}
            <div className="w-[300px] md:w-[500px] h-[300px] md:h-[500px] relative">
              <img
                src={steps[activeStep].imageUrl}
                className="w-full h-full z-0 rounded-[10.03px] ml-10"
                alt={`proceso admision ${activeStep + 1}`}
              />
            </div>

            {/* Text Section */}
            <div className="w-full md:w-[674px] z-10 flex-col justify-start items-end gap-6 flex mr-10">
              <div className="self-stretch h-80 px-4 md:px-6 py-8 bg-white rounded-[20px] shadow border border-[#e4e4de] flex-col justify-start items-center gap-4 flex">
                <div className="self-stretch flex-col justify-between items-start flex">
                  <div className="self-stretch flex-col justify-start items-start gap-2 flex">
                    ...
                    <div className="text-[#1e1e1e] text-xl md:text-2xl font-semibold">
                  ...
                  {activeStep === 0 && (
                    <div className="flex gap-4 mt-10">
                      <Link to={steps[activeStep].applyLink}>
                        <div className="h-10 px-4 md:px-6 py-2 bg-[#009bce] rounded-2xl flex justify-center items-center">
                          <div className="text-[#f2f2f2] text-sm md:text-base font-medium">
                            Aplicar
                          </div>
                        </div>
                      </Link>
                      <Link to={steps[activeStep].visitLink}>
                        <div className="px-4 md:px-6 py-2 bg-[#b0cb4f] rounded-2xl flex justify-center items-center">
                          <div className="text-[#f2f2f2] text-sm md:text-base font-medium">
                            Planea tu visita
                          </div>
                        </div>
          ...
          {/* Navigation Arrows */}
          <div className="flex flex-row self-end md:mr-20 ">
            <button
            ...
            <button
              className={`p-3 rounded-full border mx-2 ${
      ...
      {/* CTA Section */}
      <div className="relative h-auto md:h-[650px] w-full px-4 md:px-16 py-16 bg-white flex flex-col justify-center items-center gap-12">
        <div className="relative flex flex-col md:flex-row justify-start items-start">
          <div className="relative flex flex-col justify-between">
            ...
            />
            <h3 className="absolute z-10 px-14 mt-20 font-semibold md:text-2xl text-lg">
              ¿Tienes preguntas?
            </h3>
            <p className="absolute z-10 md:mt-32 mt-28 px-14 text-sm md:text-base">
            ...
            <a href="mailto:direccionpreescolar@colegiosenda.edu.mx">
              <div className="absolute h-10 ml-14 px-8 z-10 md:bottom-14 bottom-10 py-2 bg-white rounded-2xl border border-white ">
                <span className="text-black/90 md:text-base text-sm font-medium">
                  Contactar
                </span>
              </div>
            </a>
