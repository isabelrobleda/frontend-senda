...
function Maternal() {
  return (
    <div className="flex flex-col items-center">
        ...
        <div className="relative max-w-screen-xl flex flex-col md:flex-row justify-between items-center gap-8 z-10">
          <div className="flex flex-col justify-start items-start gap-8 text-left md:px-0 px-8">
            ...
            <div className="w-full md:w-auto flex flex-col sm:flex-row gap-3 md:self-start self-center">
              <WhatsAppButton
                message="Hola, me gustaría agendar una visita para conocer Maternal en el Colegio Senda."
                source="maternal_hero"
      ...
      {/* CTA Section */}
      <QuestionsCTA
        text="Si tienes preguntas sobre el maternal, no dudes en enviarle un correo electrónico a Roxana Fernández, nuestra Directora de Preescolar"
        email="roxana.fernandez@colegiosenda.edu.mx"
        image={CTAImgMaternal}
        imageAlt="Alumnos de maternal del Colegio Senda"
      />
    </div>
  );
}
